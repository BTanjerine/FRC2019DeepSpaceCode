...
class TeleOp(Command):
    ...
    def execute(self):
        ...
        # y = -self.sideCon.getY()
        # x = self.sideCon.getX()
        armUp = self.controller.getTriggerAxis(self.controller.Hand.kRightHand)     # arm up percent output
        armDown = self.controller.getTriggerAxis(self.controller.Hand.kLeftHand)    # arm down percent output
